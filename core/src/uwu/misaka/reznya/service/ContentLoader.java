...
public class ContentLoader {
    ...
    public static final Texture bullet_example = new Texture("textures/bullets/example.png");
    public static final Texture menu_banner = new Texture("textures/icons/banner.png");
}
